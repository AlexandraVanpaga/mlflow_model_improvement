...
ЭТАП 2:
Уже на этом этапе добавила дополнительные колонки (округ, район, удаление от центра Москвы, десятилетие построения здания. логарифмированый таргет), так как это нужно для понимания закономерностей.
